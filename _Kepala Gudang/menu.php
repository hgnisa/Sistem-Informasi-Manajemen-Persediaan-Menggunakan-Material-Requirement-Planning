	...
	<?php include "_header.php"; ?>
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-12">
						<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md btn-info"><a  style="color:white">Tambah Produk</a>&nbsp;&nbsp;<i class="fa fa-plus"></i></button>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									?>
                                        <tr>
											...
											<a href="menu_edit.php?id=<?php echo $m['ID_produk'];?>&aksi=edit" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
											<a href="controller/proses_produk.php?id=<?php echo $m['ID_produk']; ?>&aksi=hapus"><button class="btn btn-warning btn-sm"><i class="fa fa-trash-o "></i></button></a>
											</td>
                                        </tr>
									 <?php } 
									}
