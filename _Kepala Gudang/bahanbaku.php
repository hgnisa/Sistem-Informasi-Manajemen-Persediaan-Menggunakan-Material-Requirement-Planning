	...
	<?php include "_header.php"; ?>
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-12">
					<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-md btn-info"><a  style="color:white">Tambah Bahan Baku</a>&nbsp;&nbsp;<i class="fa fa-plus"></i></button> 
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
											...
											<th width="10%"><center><small><b>Aksi</center></th>
                                        </tr>
                                    </thead>
                                    <tbody>
									<?php
									...
									?>
                                        <tr>
											...
											<td><center>
											<a href="bahanbaku_edit.php?id=<?php echo $m['ID_bahanbaku'];?>&aksi=edit" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
											<a href="controller/proses_bahanbaku.php?id=<?php echo $m['ID_bahanbaku']; ?>&aksi=hapus"><button class="btn btn-warning btn-sm"><i class="fa fa-trash-o "></i></button></a>
											</center></td>
                                        </tr>
									 <?php 
										}
