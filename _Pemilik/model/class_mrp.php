...
class mrp {
	...
	$data = mysqli_query($this->con, "SELECT * from mrp_perhitungan INNER JOIN bahanbaku ON mrp_perhitungan.ID_bahanbaku = bahanbaku.ID_bahanbaku  WHERE mrp_perhitungan.porel NOT NULL");
