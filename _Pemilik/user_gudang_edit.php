                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
							...
							<form action="controller/user_gudang_edit.php" method="post" class="form-horizontal">
								<div class="card-body">
									<div class="col col-sm-8">
										...
										<a href="user_gudang.php"><button type="button" class="btn btn-outline-link btn-md btn-block">Batal</button></a>
									</div>
									<hr>
								</div>
							</form>
