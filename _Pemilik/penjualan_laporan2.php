	...
	?>
        <div class="content">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-md-12">
						<a class="btn btn-info" style="color:white" href="penjualan_print.php?tanggal=<?php print $tgl_awal.$tgl_akhir;?>">Cetak&nbsp;&nbsp;<i class="fa fa-print"></i></button></a>
						<br><br>
						<div class="card">
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<td><center><?php print "Rp. ".$m['pj_harga']; ?></center></td>
                                        </tr>
									 <?php } ?>
									</tbody>
								</table>
